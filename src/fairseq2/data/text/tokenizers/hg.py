...
from fairseq2.data.text.tokenizers import TextTokenDecoder, TextTokenEncoder
...
if TYPE_CHECKING:
    ...
    class HuggingFaceTokenModel:
        ...
        def decode(
            ...
            return self._tok.decode(token_indices)
...
@final
class HuggingFaceTokenEncoder(TextTokenEncoder):
    _model: HuggingFaceTokenModel
    _prefix_indices: list[int]
    _suffix_indices: list[int]
    _prefix_index_pt: Tensor | None
    _suffix_index_pt: Tensor | None
    _device: Device | None
    _pin_memory: bool
...
@final
class HuggingFaceTokenDecoder(TextTokenDecoder):
    _model: HuggingFaceTokenModel
