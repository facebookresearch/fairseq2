...
class Wav2Vec2AsrMetricBag(MetricBag):
    ...
    def update_step_metrics(
        ...
        :param ctc_loss:
            The total CTC loss generated by the model for ``batches``.
        :param time:
        ...
        normalized_ctc_loss = ctc_loss.cpu() / batch_size / math.log(2)

        self.ctc_loss.update(normalized_ctc_loss, weight=batch_size)
