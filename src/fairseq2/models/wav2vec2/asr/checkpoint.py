...
def _convert_wav2vec2_asr_checkpoint(
    ...
    if "w2v_encoder.proj.weight" in checkpoint:  # fairseq
        if config.encoder_config.norm_order == TransformerNormOrder.POST:
            # fmt: off
            checkpoint["encoder_frontend.layer_norm.weight"] = checkpoint["w2v_encoder.w2v_model.encoder.layer_norm.weight"]
            checkpoint["encoder_frontend.layer_norm.bias"]   = checkpoint["w2v_encoder.w2v_model.encoder.layer_norm.bias"]
            # fmt: on

            del checkpoint["w2v_encoder.w2v_model.encoder.layer_norm.weight"]
            del checkpoint["w2v_encoder.w2v_model.encoder.layer_norm.bias"]
