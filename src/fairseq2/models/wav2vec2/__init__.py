...
from fairseq2.models.wav2vec2.checkpoint import (
    _convert_wav2vec2_checkpoint as _convert_wav2vec2_checkpoint,
)
...
from fairseq2.models.wav2vec2.config import (
    _register_wav2vec2_configs as _register_wav2vec2_configs,
)
...
from fairseq2.models.wav2vec2.factory import (
    _create_wav2vec2_model as _create_wav2vec2_model,
)
