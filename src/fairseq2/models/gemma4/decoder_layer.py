...
from fairseq2.models.transformer import AttentionBiasCache, FeedForwardNetwork, MultiheadAttention
...
class Gemma4DecoderLayer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.register_buffer(
            "layer_scalar", torch.ones(1) * layer_scalar_init
        )
    ...
    def forward(
        ...
        *,
        ...
        hidden_states = self._forward_self_attn(
            hidden_states, seqs_layout, bias_cache, state_bag,
    ...
    def _forward_ple(
        self, hidden_states: Tensor, per_layer_input: Tensor
    ) -> Tensor:
