...
from fairseq2.models.s2t_transformer.tokenizer import S2TTransformerTokenizerConfig
from fairseq2.models.transformer import TransformerModel

get_s2t_transformer_model_hub = ModelHubAccessor(
    S2T_TRANSFORMER_FAMILY, TransformerModel, S2TTransformerConfig
)

get_s2t_transformer_tokenizer_hub = TokenizerHubAccessor(
    S2T_TRANSFORMER_FAMILY, S2TTransformerTokenizerConfig
)
