...
get_llama_model_hub = ModelHubAccessor(LLAMA_FAMILY, TransformerLM, LLaMAConfig)

get_llama_tokenizer_hub = TokenizerHubAccessor(LLAMA_FAMILY, LLaMATokenizerConfig)
