...
_HG_KEY_MAP: Final = {
    ...
    r"^model\.layers\.([0-9]+)\.laurel_block\.L_proj\.":         r"decoder.layers.\1.laurel.L_proj.",
    r"^model\.layers\.([0-9]+)\.laurel_block\.R_proj\.":         r"decoder.layers.\1.laurel.R_proj.",
