...
def create_checkpoint_loader(resolver: DependencyResolver) -> CheckpointLoader:
    ...
    third_party_loaders = resolver.resolve_all(CheckpointLoader, key="delegate")

    for loader in third_party_loaders:
        loaders.append(loader)

    return DelegatingCheckpointLoader(loaders)
