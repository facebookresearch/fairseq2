...
get_mistral_model_hub = ModelHubAccessor(MISTRAL_FAMILY, TransformerLM, MistralConfig)

get_mistral_tokenizer_hub = TokenizerHubAccessor(MISTRAL_FAMILY, NoneType)
