...
def _get_fairseq_param_key_map() -> Dict[str, str]:
    return {
        ...
        r"^w2v_encoder\.w2v_model\.post_extract_proj\.":                                r"encoder_frontend.post_extract_proj.",
        r"^w2v_encoder\.w2v_model\.mask_emb":                                           r"encoder_frontend.masker.temporal_mask_embed",
