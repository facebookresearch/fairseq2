...
def _get_fairseq_param_key_map() -> Dict[str, str]:
    return {
        ...
        r"^w2v_encoder\.w2v_model\.encoder\.pos_conv\.0\.":                             r"frontend.pos_encoder.conv.",
        r"^w2v_encoder\.w2v_model\.feature_extractor\.conv_layers\.([0-9]+)\.0.":       r"frontend.feature_extractor.layers.\1.conv.",
        r"^w2v_encoder\.w2v_model\.feature_extractor\.conv_layers\.0\.2.":              r"frontend.feature_extractor.layers.0.group_norm.",
        r"^w2v_encoder\.w2v_model\.layer_norm\.":                                       r"frontend.feature_layer_norm.",
        r"^w2v_encoder\.w2v_model\.mask_emb":                                           r"frontend.feature_masker.temporal_mask_embed",
        r"^w2v_encoder\.w2v_model\.post_extract_proj\.":                                r"frontend.feature_proj.",

        # wav2vec 2.0
        r"^encoder\.pos_conv\.0\.":                       r"frontend.pos_encoder.conv.",
        r"^feature_extractor\.conv_layers\.([0-9]+)\.0.": r"frontend.feature_extractor.layers.\1.conv.",
        r"^feature_extractor\.conv_layers\.0\.2.":        r"frontend.feature_extractor.layers.0.group_norm.",
        r"^layer_norm\.":                                 r"frontend.feature_layer_norm.",
        r"^post_extract_proj\.":                          r"frontend.feature_proj.",
        r"^mask_emb":                                     r"frontend.feature_masker.temporal_mask_embed",
        r"^quantizer\.":                                  r"vector_quantizer.",
        r"^final_proj\.":                                 r"final_proj.",
