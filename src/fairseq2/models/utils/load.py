...
def _get_fairseq_param_key_map() -> Dict[str, str]:
    return {
        ...
        r"^w2v_encoder\.w2v_model\.layer_norm\.":                                       r"encoder_frontend.feature_layer_norm.",
        r"^w2v_encoder\.w2v_model\.mask_emb":                                           r"encoder_frontend.mask.temporal_mask_embed",
        r"^w2v_encoder\.w2v_model\.post_extract_proj\.":                                r"encoder_frontend.feature_proj.",
        ...
        r"^layer_norm\.":                                 r"encoder_frontend.feature_layer_norm.",
        r"^post_extract_proj\.":                          r"encoder_frontend.feature_proj.",
        r"^mask_emb":                                     r"encoder_frontend.feature_masker.temporal_mask_embed",
