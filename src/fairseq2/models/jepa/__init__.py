...
from fairseq2.models.jepa._setup import (
    convert_jepa_checkpoint as convert_jepa_checkpoint,
)
from fairseq2.models.jepa._setup import create_jepa_model as create_jepa_model
from fairseq2.models.jepa._setup import register_jepa_family as register_jepa_family
