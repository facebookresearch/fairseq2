...
from fairseq2.config import ConfigRegistrar
...
def register_transformer_configs(container: DependencyContainer) -> None:
    arch = ConfigRegistrar(container, TransformerConfig)
