...
from fairseq2.error import InfraError, InvalidOperationError
        ...
        *,
        ...
        def do_save() -> None:
            ...
            try:
                ...
                raise InfraError(
                    f"The background process has failed while saving the Hugging Face model of step {step_nr}. See the nested exception for details."  # fmt: skip
                ) from ex
