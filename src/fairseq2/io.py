        ...
        *,
        ...
        with warnings.catch_warnings():
            ...
            try:
                ...
                raise InfraError(
                    f"A system error has occurred while reading the '{file}' tensor file. See the nested exception for details."
                ) from ex
        ...
        with warnings.catch_warnings():
            ...
            def dump_error() -> TensorDumpError:
                return TensorDumpError(
                    file, f"A system error has occurred while saving the '{file}' tensor file. See the nested exception for details.",  # fmt: skip
                )
            ...
            try:
                ...
                raise InfraError(
                    f"A system error has occurred while saving the '{file}' tensor file. See the nested exception for details."
                ) from ex
            ...
            try:
                ...
                raise TensorDumpError(
                    file, f"The '{file}' tensor file cannot be saved. See the nested exception for details."  # fmt: skip
                ) from ex
            finally:
                fp.close()
...
class HuggingFaceSafetensorsLoader(SafetensorsLoader):
    ...
    def load(
        ...
        try:
            ...
            raise InfraError(
                f"A system error has occurred while reading the '{file}' Safetensors file. See the nested exception for details."
            ) from ex
        except (RuntimeError, PickleError) as ex:
            raise TensorLoadError(
                file, f"The '{file}' Safetensors file cannot be loaded. See the nested exception for details."  # fmt: skip
            ) from ex
