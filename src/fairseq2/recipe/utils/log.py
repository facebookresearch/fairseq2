...
from fairseq2.recipe.utils.module import get_module_size_info
from fairseq2.runtime.dependency import DependencyResolver
from fairseq2.utils.env import get_env


def log_environment_info(resolver: DependencyResolver) -> None:
    """Log information about the host system and the installed software."""
    log_system_info(resolver)

    log_software_info(resolver)

    log_environment_variables(resolver)


def log_system_info(resolver: DependencyResolver) -> None:
...
def log_software_info(resolver: DependencyResolver) -> None:
...
def log_environment_variables(resolver: DependencyResolver) -> None:
