...
from fairseq2.recipe.config import DatasetSectionBase, get_recipe_config_section
...
def load_dataset(resolver: DependencyResolver) -> object:
    ...
    dataset_section = get_recipe_config_section(resolver, "dataset", DatasetSectionBase)
