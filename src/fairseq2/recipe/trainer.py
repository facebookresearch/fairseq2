...
from fairseq2.recipe.task import StopExecutionException, Task
...
def create_trainer(
    ...
    trainer_section = get_recipe_config_section(resolver, "trainer", TrainerSection)
    ...
    score_metric_descriptor = get_score_metric_descriptor(resolver)

    regime_section = get_recipe_config_section(resolver, "regime", RegimeSection)
