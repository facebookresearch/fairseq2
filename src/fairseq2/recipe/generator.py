...
from fairseq2.recipe.config import GeneratorSection, get_recipe_config_section
...
def create_generator(
    ...
    generator_section = get_recipe_config_section(
        resolver, "generator", GeneratorSection
    )
