...
from fairseq2.recipe.config import TokenizerSection, get_recipe_config_section
...
def _do_load_tokenizer(resolver: DependencyResolver, section_name: str) -> Tokenizer:
    ...
    tokenizer_section = get_recipe_config_section(
        resolver, section_name, TokenizerSection
    )
