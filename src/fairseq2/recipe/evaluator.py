...
from fairseq2.recipe.config import EvaluatorSection, get_recipe_config_section
from fairseq2.recipe.device import create_device_stat_tracker
from fairseq2.recipe.error import RecipeError, UnitError
...
def create_evaluator(
    ...
    evaluator_section = get_recipe_config_section(
        resolver, "evaluator", EvaluatorSection
    )
