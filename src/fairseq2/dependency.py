...
class DependencyContainer(ABC):
    ...
    def register(
        ...
        *,
        ...
        kls_args: tuple[Hashable, ...] | None = None,
    ) -> None: ...
...
class StandardDependencyContainer(DependencyContainer, DependencyResolver):
    ...
    def register(
        ...
        *,
        ...
        self._register(kls, kls_args, key, _Registration(factory=factory))
    ...
    def register_instance(
        ...
        *,
        ...
        self._register(kls, kls_args, key, _Registration(obj))

    def _register(
        self,
        kls: type[object],
        kls_args: tuple[Hashable, ...] | None,
        key: Hashable | None,
...
class DependencyProvider(Provider[T]):
    ...
    def __init__(
        ...
        *,
        ...
        self._kls = kls
        self._kls_args = kls_args

    @override
    def resolve(self, key: Hashable) -> T:
        obj = self._resolver.resolve(self._kls, key=key, kls_args=self._kls_args)
