...
def register_library(container: DependencyContainer) -> None:
    ...
    # Models
    register_model_families(container)

    # Tokenizers
    register_tokenizer_families(container)


def register_model_families(container: DependencyContainer) -> None:
    # JEPA
...
def register_tokenizer_families(container: DependencyContainer) -> None:
    # Char
