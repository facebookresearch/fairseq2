...
from fairseq2.recipe.error import InconsistentGradNormError, MinimumLossScaleReachedError
#from fairseq2.recipe.asr import AsrEvalConfig, load_asr_evaluator
...
#from fairseq2.recipe.lm import (
...
#    load_text_generator,
#)
#from fairseq2.recipe.mt import (
#    MTEvalConfig,
#    MTTrainConfig,
#    TextTranslateConfig,
#    load_mt_evaluator,
...
#    _register_wav2vec2_cli(cli)
    ...
    register_user_error_types(cli)

#    signature = "extension_function(resolver: DependencyResolver, cli: Cli) -> None"
#
#    run_extensions("fairseq2.cli", signature, cli)
...
def register_user_error_types(cli: Cli) -> None:
    ...
    cli.register_user_error_type(UnknownTokenizerError)
    cli.register_user_error_type(UnknownTokenizerFamilyError)
