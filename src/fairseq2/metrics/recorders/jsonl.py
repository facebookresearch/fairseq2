...
class JsonlMetricRecorder(MetricRecorder):
    ...
    def record_metric_values(
        ...
        try:
            ...
            raise InfraError(
                f"A system error has occurred while saving the metric values of the '{section}' to the JSON file. See the nested exception for details."
            ) from ex
    ...
    def _get_stream(self, section: str) -> TextIO:
        ...
        try:
            ...
            raise InfraError(
                f"A system error has occurred while creating the '{file.parent}' metric directory. See the nested exception for details."
            ) from ex
        ...
        try:
            ...
            raise InfraError(
                f"A system error has occurred while creating the '{file}' metric file for the '{section} section. See the nested exception for details."
            ) from ex
