...
class TestGemma4Router:
    ...
    def test_indices_within_range(self) -> None:
        ...
        num_experts = 8
        router = Gemma4Router(model_dim=32, num_experts=num_experts, top_k=2).to(device)
    ...
    def test_scalar_root_size(self) -> None:
        ...
        model_dim = 64
        router = Gemma4Router(model_dim=model_dim, num_experts=8, top_k=2)
    ...
    def test_per_expert_scale_effect(self) -> None:
        ...
        router = Gemma4Router(model_dim=32, num_experts=4, top_k=2).to(device)
...
class TestGemma4Experts:
    ...
    def test_gelu_tanh_activation(self) -> None:
        ...
        experts = Gemma4Experts(model_dim=16, num_experts=2, moe_intermediate_size=8)
