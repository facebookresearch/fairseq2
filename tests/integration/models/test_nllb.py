...
DEU_SENTENCE: Final = "Am Montag kündigten Wissenschaftler der Medizinischen Fakultät der Stanford University die Erfindung eines neuen diagnostischen Werkzeugs an, das Zellen nach Typ sortieren kann: Ein winziger druckbarer Chip, der mit standardmäßigen Tintenstrahldrucker für möglicherweise etwa einen US-Cent pro Stück hergestellt werden kann."
...
def test_load_dense_distill_600m() -> None:
    ...
    output = translator([ENG_SENTENCE])

    assert output.sentences == [DEU_SENTENCE]
