...
"""Integration tests for all OLMO2 model variants."""
...
# List of OLMO2 models to test: (model_name, local_path)
OLMO2_MODELS = [
    ("olmo2-0425-1b", "/datasets/pretrained-llms/OLMo-2-0425-1B"),
    ("olmo2-1124-7b", "/datasets/pretrained-llms/OLMo-2-1124-7B"),
    # ("olmo2-1124-13b", "/datasets/pretrained-llms/OLMo-2-1124-13B"),  # OOM
]


@pytest.fixture(scope="module")
def hub():
    """Get the OLMO2 model hub."""
    return get_olmo2_model_hub()


@pytest.mark.parametrize("model_name,local_path", OLMO2_MODELS)
