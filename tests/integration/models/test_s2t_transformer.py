...
from fairseq2.data.tokenizers import Tokenizer, tokenizer_hub
...
from fairseq2.models.s2t_transformer import s2t_transformer_hub
...
def test_load_s2t_transformer_mustc_st_jt_m() -> None:
    ...
    model = s2t_transformer_hub().load(model_name, device=device, dtype=torch.float32)
