...
.. note::
   Please note that fairseq is primarily a research library. This means
   backwards compatibility between releases is kept at a best effort and is not
   always guaranteed. You should exercise caution if you plan to use fairseq in
   production.
