...
from .dataset import LM_POFT_DATASET, LMPOFTDatasetConfig


@dataclass(kw_only=True)
class LMPOFTDatasetSection(DatasetSection):
    path: str | None = None
...
class LMPOFTConfig:
    ...
    dataset: LMPOFTDatasetSection = field(
        default_factory=lambda: LMPOFTDatasetSection(
            family=LM_POFT_DATASET,
            batch_size=16,
            config_overrides=LMPOFTDatasetConfig(path="hg://facebook/fairseq2-lm-gsm8k"),
        )
    )
