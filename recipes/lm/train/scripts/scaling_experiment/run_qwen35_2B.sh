#!/bin/bash
# Qwen 3.5 2B training on FineWeb-Edu 10BT (4-node, all optimizations)
#SBATCH --job-name=qwen35_2B
#SBATCH --nodes=4
...
OUTPUT_DIR=/checkpoint/smallomnillm/yunchaoyang1/qwen35_pretrain/2B/ablation_all_4node
