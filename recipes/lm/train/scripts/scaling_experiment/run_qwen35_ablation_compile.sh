#!/bin/bash
# Ablation: torch.compile with max-autotune
# Baseline → compile=true, mode=max-autotune
#SBATCH --job-name=qwen35_ablation_compile
#SBATCH --nodes=1
...
OUTPUT_DIR=/checkpoint/smallomnillm/yunchaoyang1/qwen35_pretrain/ablation_compile
