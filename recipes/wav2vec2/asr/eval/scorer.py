...
class Wav2Vec2AsrScorer:
    """Replaces the criterion for evaluation and extends it to calculate the WER."""
    ...
    def __call__(
        ...
        ctc_loss, logits, logits_layout = self._forward(batch)
    ...
    def _forward(self, batch: Seq2SeqBatch) -> tuple[Tensor, Tensor, BatchLayout]:
        """
        :return: tuple[Tensor, Tensor, BatchLayout] (if calling module(..., return_logits=True) - loss, logits, layout
        """
